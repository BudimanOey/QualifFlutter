...
class ThemeProvider extends ChangeNotifier {
  ...
  Color iconColor() {
    return _selectedTheme == darkTheme ? Colors.white : Color.fromARGB(255, 122, 118, 118);
  }

  Color backgroundColor() {
    return _selectedTheme == darkTheme ? Color.fromARGB(255, 122, 118, 118) : Colors.white;
  }
